...
let res = await fetch('https://api.github.com/repos/DanielDiod/Runa-Bot')
...
await conn.sendUrl(m.chat, git, m, { externalAdReply: { mediaType: 1, renderLargerThumbnail: true, thumbnail: imagen2, thumbnailUrl: imagen1, title: '\t\t\t\t\t\tRuna Bot 🍟', }})
