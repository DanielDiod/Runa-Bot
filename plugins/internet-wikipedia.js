...
conn.reply(m.chat, `Resultados\n\n` + res.result.isi, { contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: 'Runa Bot | Wikipedia', body: '𝗦𝘂𝗽𝗲𝗿 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 𝗕𝗼𝘁 🐱❤️', previewType: 0, thumbnail: imagen2, sourceUrl: channel }}})
}).catch((e) => {
